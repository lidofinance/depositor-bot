...
# Gas fee percentile
GAS_FEE_PERCENTILE = os.getenv('GAS_FEE_PERCENTILE', 30)
GAS_FEE_PERCENTILE_DAYS_HISTORY = os.getenv('GAS_FEE_PERCENTILE_DAYS_HISTORY', 2)
GAS_PRIORITY_FEE_PERCENTILE = os.getenv('GAS_PRIORITY_FEE_PERCENTILE', 55)
