...
BLSSignature: TypeAlias = altair.BLSSignature


Domain: TypeAlias = altair.Domain


DomainType: TypeAlias = altair.DomainType


Epoch: TypeAlias = altair.Epoch


Gwei: TypeAlias = altair.Gwei


Hash32: TypeAlias = altair.Hash32


Slot: TypeAlias = altair.Slot


Version: TypeAlias = altair.Version


ExecutionAddress: TypeAlias = altair.ExecutionAddress
...
AggregationBits: TypeAlias = altair.AggregationBits


Balances: TypeAlias = altair.Balances


DepositProof: TypeAlias = altair.DepositProof


JustificationBits: TypeAlias = altair.JustificationBits


RandaoMixes: TypeAlias = altair.RandaoMixes


Slashings: TypeAlias = altair.Slashings


Fork: TypeAlias = altair.Fork


Attnets: TypeAlias = altair.Attnets


ErrorMessage: TypeAlias = altair.ErrorMessage


InactivityScores: TypeAlias = altair.InactivityScores


SyncCommitteeBits: TypeAlias = altair.SyncCommitteeBits


SyncAggregate: TypeAlias = altair.SyncAggregate


Syncnets: TypeAlias = altair.Syncnets


SyncSubcommitteeBits: TypeAlias = altair.SyncSubcommitteeBits


SyncAggregatorSelectionData: TypeAlias = altair.SyncAggregatorSelectionData


CurrentSyncCommitteeBranch: TypeAlias = altair.CurrentSyncCommitteeBranch


FinalityBranch: TypeAlias = altair.FinalityBranch


NextSyncCommitteeBranch: TypeAlias = altair.NextSyncCommitteeBranch
...
BLSPubkey: TypeAlias = altair.BLSPubkey


SyncCommitteePubkeys: TypeAlias = altair.SyncCommitteePubkeys


SyncCommittee: TypeAlias = altair.SyncCommittee


DepositData: TypeAlias = altair.DepositData


DepositDataList: TypeAlias = altair.DepositDataList


Deposit: TypeAlias = altair.Deposit


Deposits: TypeAlias = altair.Deposits


DepositMessage: TypeAlias = altair.DepositMessage


Validator: TypeAlias = altair.Validator


Validators: TypeAlias = altair.Validators


CommitteeIndex: TypeAlias = altair.CommitteeIndex


ForkDigest: TypeAlias = altair.ForkDigest


Root: TypeAlias = altair.Root
...
SyncCommitteeContribution: TypeAlias = altair.SyncCommitteeContribution


Eth1Block: TypeAlias = altair.Eth1Block


BeaconBlockRoots: TypeAlias = altair.BeaconBlockRoots


SigningData: TypeAlias = altair.SigningData


Eth1Data: TypeAlias = altair.Eth1Data


Eth1DataVotes: TypeAlias = altair.Eth1DataVotes


Checkpoint: TypeAlias = altair.Checkpoint


AttestationData: TypeAlias = altair.AttestationData


Attestation: TypeAlias = altair.Attestation


Attestations: TypeAlias = altair.Attestations


ForkData: TypeAlias = altair.ForkData


StateRoots: TypeAlias = altair.StateRoots


HistoricalRoots: TypeAlias = altair.HistoricalRoots


BlockRoots: TypeAlias = altair.BlockRoots


HistoricalBatch: TypeAlias = altair.HistoricalBatch


ValidatorIndex: TypeAlias = altair.ValidatorIndex


ContributionAndProof: TypeAlias = altair.ContributionAndProof


SignedContributionAndProof: TypeAlias = altair.SignedContributionAndProof


SyncCommitteeMessage: TypeAlias = altair.SyncCommitteeMessage


AggregateAndProof: TypeAlias = altair.AggregateAndProof


SignedAggregateAndProof: TypeAlias = altair.SignedAggregateAndProof


VoluntaryExit: TypeAlias = altair.VoluntaryExit


SignedVoluntaryExit: TypeAlias = altair.SignedVoluntaryExit


VoluntaryExits: TypeAlias = altair.VoluntaryExits


BeaconBlockHeader: TypeAlias = altair.BeaconBlockHeader


LightClientHeader: TypeAlias = altair.LightClientHeader


LightClientOptimisticUpdate: TypeAlias = altair.LightClientOptimisticUpdate


LightClientFinalityUpdate: TypeAlias = altair.LightClientFinalityUpdate


LightClientUpdate: TypeAlias = altair.LightClientUpdate


LightClientUpdates: TypeAlias = altair.LightClientUpdates


LightClientBootstrap: TypeAlias = altair.LightClientBootstrap


SignedBeaconBlockHeader: TypeAlias = altair.SignedBeaconBlockHeader


ProposerSlashing: TypeAlias = altair.ProposerSlashing


ProposerSlashings: TypeAlias = altair.ProposerSlashings


AttestingIndices: TypeAlias = altair.AttestingIndices


IndexedAttestation: TypeAlias = altair.IndexedAttestation


AttesterSlashing: TypeAlias = altair.AttesterSlashing


AttesterSlashings: TypeAlias = altair.AttesterSlashings
...
NodeID: TypeAlias = altair.NodeID


SubnetID: TypeAlias = altair.SubnetID


Ether: TypeAlias = altair.Ether


ParticipationFlags: TypeAlias = altair.ParticipationFlags


EpochParticipation: TypeAlias = altair.EpochParticipation
...
ForkChoiceNode: TypeAlias = altair.ForkChoiceNode


LatestMessage: TypeAlias = altair.LatestMessage
...
Seen: TypeAlias = altair.Seen


LightClientStore: TypeAlias = altair.LightClientStore
...
def validate_merge_block(block: BeaconBlock) -> None:
    ...
    """
    if config.TERMINAL_BLOCK_HASH != EMPTY_BLOCK_HASH:
...
def prepare_execution_payload(
    ...
    if not is_merge_transition_complete(state):
        ...
        is_terminal_block_hash_set = config.TERMINAL_BLOCK_HASH != EMPTY_BLOCK_HASH
