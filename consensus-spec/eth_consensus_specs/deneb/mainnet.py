...
BLSSignature: TypeAlias = capella.BLSSignature


Domain: TypeAlias = capella.Domain


DomainType: TypeAlias = capella.DomainType


Epoch: TypeAlias = capella.Epoch


Gwei: TypeAlias = capella.Gwei


Hash32: TypeAlias = capella.Hash32


Slot: TypeAlias = capella.Slot


Version: TypeAlias = capella.Version


ExecutionAddress: TypeAlias = capella.ExecutionAddress


PayloadValidationStatus: TypeAlias = capella.PayloadValidationStatus
...
AggregationBits: TypeAlias = capella.AggregationBits


Balances: TypeAlias = capella.Balances


DepositProof: TypeAlias = capella.DepositProof


JustificationBits: TypeAlias = capella.JustificationBits


RandaoMixes: TypeAlias = capella.RandaoMixes


Slashings: TypeAlias = capella.Slashings


Fork: TypeAlias = capella.Fork


Attnets: TypeAlias = capella.Attnets


ErrorMessage: TypeAlias = capella.ErrorMessage


InactivityScores: TypeAlias = capella.InactivityScores


SyncCommitteeBits: TypeAlias = capella.SyncCommitteeBits


SyncAggregate: TypeAlias = capella.SyncAggregate


Syncnets: TypeAlias = capella.Syncnets


SyncSubcommitteeBits: TypeAlias = capella.SyncSubcommitteeBits


SyncAggregatorSelectionData: TypeAlias = capella.SyncAggregatorSelectionData


CurrentSyncCommitteeBranch: TypeAlias = capella.CurrentSyncCommitteeBranch


FinalityBranch: TypeAlias = capella.FinalityBranch


NextSyncCommitteeBranch: TypeAlias = capella.NextSyncCommitteeBranch


ExtraData: TypeAlias = capella.ExtraData


LogsBloom: TypeAlias = capella.LogsBloom


Transaction: TypeAlias = capella.Transaction


Transactions: TypeAlias = capella.Transactions


PowBlock: TypeAlias = capella.PowBlock


ExecutionBranch: TypeAlias = capella.ExecutionBranch
...
BLSPubkey: TypeAlias = capella.BLSPubkey


SyncCommitteePubkeys: TypeAlias = capella.SyncCommitteePubkeys


SyncCommittee: TypeAlias = capella.SyncCommittee


DepositData: TypeAlias = capella.DepositData


DepositDataList: TypeAlias = capella.DepositDataList


Deposit: TypeAlias = capella.Deposit


Deposits: TypeAlias = capella.Deposits


DepositMessage: TypeAlias = capella.DepositMessage


Validator: TypeAlias = capella.Validator


Validators: TypeAlias = capella.Validators


CommitteeIndex: TypeAlias = capella.CommitteeIndex


ForkDigest: TypeAlias = capella.ForkDigest


Root: TypeAlias = capella.Root


HistoricalSummary: TypeAlias = capella.HistoricalSummary


HistoricalSummaries: TypeAlias = capella.HistoricalSummaries
...
SyncCommitteeContribution: TypeAlias = capella.SyncCommitteeContribution


Eth1Block: TypeAlias = capella.Eth1Block
...
SigningData: TypeAlias = capella.SigningData


Eth1Data: TypeAlias = capella.Eth1Data


Eth1DataVotes: TypeAlias = capella.Eth1DataVotes


Checkpoint: TypeAlias = capella.Checkpoint


AttestationData: TypeAlias = capella.AttestationData


Attestation: TypeAlias = capella.Attestation


Attestations: TypeAlias = capella.Attestations


ForkData: TypeAlias = capella.ForkData


StateRoots: TypeAlias = capella.StateRoots


HistoricalRoots: TypeAlias = capella.HistoricalRoots


BlockRoots: TypeAlias = capella.BlockRoots


ValidatorIndex: TypeAlias = capella.ValidatorIndex


BLSToExecutionChange: TypeAlias = capella.BLSToExecutionChange


SignedBLSToExecutionChange: TypeAlias = capella.SignedBLSToExecutionChange


BLSToExecutionChanges: TypeAlias = capella.BLSToExecutionChanges


ContributionAndProof: TypeAlias = capella.ContributionAndProof


SignedContributionAndProof: TypeAlias = capella.SignedContributionAndProof


SyncCommitteeMessage: TypeAlias = capella.SyncCommitteeMessage


AggregateAndProof: TypeAlias = capella.AggregateAndProof


SignedAggregateAndProof: TypeAlias = capella.SignedAggregateAndProof


VoluntaryExit: TypeAlias = capella.VoluntaryExit


SignedVoluntaryExit: TypeAlias = capella.SignedVoluntaryExit


VoluntaryExits: TypeAlias = capella.VoluntaryExits


BeaconBlockHeader: TypeAlias = capella.BeaconBlockHeader
...
SignedBeaconBlockHeader: TypeAlias = capella.SignedBeaconBlockHeader


ProposerSlashing: TypeAlias = capella.ProposerSlashing


ProposerSlashings: TypeAlias = capella.ProposerSlashings


AttestingIndices: TypeAlias = capella.AttestingIndices


IndexedAttestation: TypeAlias = capella.IndexedAttestation


AttesterSlashing: TypeAlias = capella.AttesterSlashing


AttesterSlashings: TypeAlias = capella.AttesterSlashings


NodeID: TypeAlias = capella.NodeID


SubnetID: TypeAlias = capella.SubnetID


Ether: TypeAlias = capella.Ether


ParticipationFlags: TypeAlias = capella.ParticipationFlags


EpochParticipation: TypeAlias = capella.EpochParticipation


PayloadId: TypeAlias = capella.PayloadId


WithdrawalIndex: TypeAlias = capella.WithdrawalIndex


Withdrawal: TypeAlias = capella.Withdrawal


Withdrawals: TypeAlias = capella.Withdrawals
...
ForkChoiceNode: TypeAlias = capella.ForkChoiceNode


LatestMessage: TypeAlias = capella.LatestMessage
...
ExpectedWithdrawals: TypeAlias = capella.ExpectedWithdrawals
...
def validate_beacon_block_gossip(
    ...
    if len(block.body.blob_kzg_commitments) > config.MAX_BLOBS_PER_BLOCK:
...
def compute_max_request_blob_sidecars() -> Uint64:
    ...
    """
    return config.MAX_REQUEST_BLOCKS_DENEB * config.MAX_BLOBS_PER_BLOCK
...
def validate_blob_sidecar_gossip(
    ...
    # [REJECT] The sidecar's index is consistent with config.MAX_BLOBS_PER_BLOCK
    if blob_sidecar.index >= config.MAX_BLOBS_PER_BLOCK:
