...
BLSSignature: TypeAlias = deneb.BLSSignature


Domain: TypeAlias = deneb.Domain


DomainType: TypeAlias = deneb.DomainType


Epoch: TypeAlias = deneb.Epoch


Gwei: TypeAlias = deneb.Gwei


Hash32: TypeAlias = deneb.Hash32


Slot: TypeAlias = deneb.Slot


Version: TypeAlias = deneb.Version


ExecutionAddress: TypeAlias = deneb.ExecutionAddress


PayloadValidationStatus: TypeAlias = deneb.PayloadValidationStatus
...
Balances: TypeAlias = deneb.Balances


DepositProof: TypeAlias = deneb.DepositProof


JustificationBits: TypeAlias = deneb.JustificationBits


RandaoMixes: TypeAlias = deneb.RandaoMixes


Slashings: TypeAlias = deneb.Slashings


Fork: TypeAlias = deneb.Fork


Attnets: TypeAlias = deneb.Attnets


ErrorMessage: TypeAlias = deneb.ErrorMessage


InactivityScores: TypeAlias = deneb.InactivityScores


SyncCommitteeBits: TypeAlias = deneb.SyncCommitteeBits


SyncAggregate: TypeAlias = deneb.SyncAggregate


Syncnets: TypeAlias = deneb.Syncnets


SyncSubcommitteeBits: TypeAlias = deneb.SyncSubcommitteeBits


SyncAggregatorSelectionData: TypeAlias = deneb.SyncAggregatorSelectionData
...
ExtraData: TypeAlias = deneb.ExtraData


LogsBloom: TypeAlias = deneb.LogsBloom


Transaction: TypeAlias = deneb.Transaction


Transactions: TypeAlias = deneb.Transactions


PowBlock: TypeAlias = deneb.PowBlock


ExecutionBranch: TypeAlias = deneb.ExecutionBranch


Blob: TypeAlias = deneb.Blob


KZGCommitmentInclusionProof: TypeAlias = deneb.KZGCommitmentInclusionProof


Blobs: TypeAlias = deneb.Blobs
...
BLSPubkey: TypeAlias = deneb.BLSPubkey
...
SyncCommitteePubkeys: TypeAlias = deneb.SyncCommitteePubkeys


SyncCommittee: TypeAlias = deneb.SyncCommittee


DepositData: TypeAlias = deneb.DepositData


DepositDataList: TypeAlias = deneb.DepositDataList


Deposit: TypeAlias = deneb.Deposit


Deposits: TypeAlias = deneb.Deposits


DepositMessage: TypeAlias = deneb.DepositMessage


Validator: TypeAlias = deneb.Validator


Validators: TypeAlias = deneb.Validators


CommitteeIndex: TypeAlias = deneb.CommitteeIndex


ForkDigest: TypeAlias = deneb.ForkDigest


Root: TypeAlias = deneb.Root


HistoricalSummary: TypeAlias = deneb.HistoricalSummary


HistoricalSummaries: TypeAlias = deneb.HistoricalSummaries


ExecutionPayloadHeader: TypeAlias = deneb.ExecutionPayloadHeader


SyncCommitteeContribution: TypeAlias = deneb.SyncCommitteeContribution


Eth1Block: TypeAlias = deneb.Eth1Block


BeaconBlockRoots: TypeAlias = deneb.BeaconBlockRoots


SigningData: TypeAlias = deneb.SigningData


Eth1Data: TypeAlias = deneb.Eth1Data


Eth1DataVotes: TypeAlias = deneb.Eth1DataVotes


Checkpoint: TypeAlias = deneb.Checkpoint


AttestationData: TypeAlias = deneb.AttestationData
...
ForkData: TypeAlias = deneb.ForkData


StateRoots: TypeAlias = deneb.StateRoots


HistoricalRoots: TypeAlias = deneb.HistoricalRoots


BlockRoots: TypeAlias = deneb.BlockRoots


ValidatorIndex: TypeAlias = deneb.ValidatorIndex
...
BLSToExecutionChange: TypeAlias = deneb.BLSToExecutionChange


SignedBLSToExecutionChange: TypeAlias = deneb.SignedBLSToExecutionChange


BLSToExecutionChanges: TypeAlias = deneb.BLSToExecutionChanges


ContributionAndProof: TypeAlias = deneb.ContributionAndProof


SignedContributionAndProof: TypeAlias = deneb.SignedContributionAndProof


SyncCommitteeMessage: TypeAlias = deneb.SyncCommitteeMessage
...
VoluntaryExit: TypeAlias = deneb.VoluntaryExit


SignedVoluntaryExit: TypeAlias = deneb.SignedVoluntaryExit


VoluntaryExits: TypeAlias = deneb.VoluntaryExits


BeaconBlockHeader: TypeAlias = deneb.BeaconBlockHeader


LightClientHeader: TypeAlias = deneb.LightClientHeader


LightClientOptimisticUpdate: TypeAlias = deneb.LightClientOptimisticUpdate
...
SignedBeaconBlockHeader: TypeAlias = deneb.SignedBeaconBlockHeader


ProposerSlashing: TypeAlias = deneb.ProposerSlashing


ProposerSlashings: TypeAlias = deneb.ProposerSlashings
...
NodeID: TypeAlias = deneb.NodeID


SubnetID: TypeAlias = deneb.SubnetID


Ether: TypeAlias = deneb.Ether


ParticipationFlags: TypeAlias = deneb.ParticipationFlags


EpochParticipation: TypeAlias = deneb.EpochParticipation


PayloadId: TypeAlias = deneb.PayloadId


WithdrawalIndex: TypeAlias = deneb.WithdrawalIndex


Withdrawal: TypeAlias = deneb.Withdrawal


Withdrawals: TypeAlias = deneb.Withdrawals


ExecutionPayload: TypeAlias = deneb.ExecutionPayload
...
BlobIndex: TypeAlias = deneb.BlobIndex


BlobIdentifier: TypeAlias = deneb.BlobIdentifier


KZGCommitment: TypeAlias = deneb.KZGCommitment


BlobKZGCommitments: TypeAlias = deneb.BlobKZGCommitments
...
KZGProof: TypeAlias = deneb.KZGProof


KZGProofs: TypeAlias = deneb.KZGProofs


BlobSidecar: TypeAlias = deneb.BlobSidecar


VersionedHash: TypeAlias = deneb.VersionedHash


ForkChoiceNode: TypeAlias = deneb.ForkChoiceNode


LatestMessage: TypeAlias = deneb.LatestMessage
...
PayloadAttributes: TypeAlias = deneb.PayloadAttributes
...
BlobsBundle: TypeAlias = deneb.BlobsBundle
...
def validate_beacon_block_gossip(
    ...
    if len(block.body.blob_kzg_commitments) > config.MAX_BLOBS_PER_BLOCK_ELECTRA:
...
def compute_max_request_blob_sidecars() -> Uint64:
    ...
    """
    # [Modified in Electra:EIP7691]
    return config.MAX_REQUEST_BLOCKS_DENEB * config.MAX_BLOBS_PER_BLOCK_ELECTRA
...
def validate_blob_sidecar_gossip(
    ...
    # [Modified in Electra:EIP7691]
    # [REJECT] The sidecar's index is consistent with config.MAX_BLOBS_PER_BLOCK_ELECTRA
    if blob_sidecar.index >= config.MAX_BLOBS_PER_BLOCK_ELECTRA:
