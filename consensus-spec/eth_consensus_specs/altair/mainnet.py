...
BLSSignature: TypeAlias = phase0.BLSSignature


Domain: TypeAlias = phase0.Domain


DomainType: TypeAlias = phase0.DomainType


Epoch: TypeAlias = phase0.Epoch


Gwei: TypeAlias = phase0.Gwei


Slot: TypeAlias = phase0.Slot


Version: TypeAlias = phase0.Version


ExecutionAddress: TypeAlias = phase0.ExecutionAddress
...
AggregationBits: TypeAlias = phase0.AggregationBits


Balances: TypeAlias = phase0.Balances


DepositProof: TypeAlias = phase0.DepositProof


JustificationBits: TypeAlias = phase0.JustificationBits


RandaoMixes: TypeAlias = phase0.RandaoMixes


Slashings: TypeAlias = phase0.Slashings


Fork: TypeAlias = phase0.Fork


Attnets: TypeAlias = phase0.Attnets


ErrorMessage: TypeAlias = phase0.ErrorMessage
...
BLSPubkey: TypeAlias = phase0.BLSPubkey
...
DepositData: TypeAlias = phase0.DepositData


DepositDataList: TypeAlias = phase0.DepositDataList


Deposit: TypeAlias = phase0.Deposit


Deposits: TypeAlias = phase0.Deposits


DepositMessage: TypeAlias = phase0.DepositMessage


Validator: TypeAlias = phase0.Validator


Validators: TypeAlias = phase0.Validators


CommitteeIndex: TypeAlias = phase0.CommitteeIndex


ForkDigest: TypeAlias = phase0.ForkDigest


Hash32: TypeAlias = phase0.Hash32


Root: TypeAlias = phase0.Root
...
Eth1Block: TypeAlias = phase0.Eth1Block


BeaconBlockRoots: TypeAlias = phase0.BeaconBlockRoots


SigningData: TypeAlias = phase0.SigningData


Eth1Data: TypeAlias = phase0.Eth1Data


Eth1DataVotes: TypeAlias = phase0.Eth1DataVotes


Checkpoint: TypeAlias = phase0.Checkpoint


AttestationData: TypeAlias = phase0.AttestationData


Attestation: TypeAlias = phase0.Attestation


Attestations: TypeAlias = phase0.Attestations


ForkData: TypeAlias = phase0.ForkData


StateRoots: TypeAlias = phase0.StateRoots


HistoricalRoots: TypeAlias = phase0.HistoricalRoots


BlockRoots: TypeAlias = phase0.BlockRoots


HistoricalBatch: TypeAlias = phase0.HistoricalBatch


ValidatorIndex: TypeAlias = phase0.ValidatorIndex
...
AggregateAndProof: TypeAlias = phase0.AggregateAndProof


SignedAggregateAndProof: TypeAlias = phase0.SignedAggregateAndProof


VoluntaryExit: TypeAlias = phase0.VoluntaryExit


SignedVoluntaryExit: TypeAlias = phase0.SignedVoluntaryExit


VoluntaryExits: TypeAlias = phase0.VoluntaryExits


BeaconBlockHeader: TypeAlias = phase0.BeaconBlockHeader
...
SignedBeaconBlockHeader: TypeAlias = phase0.SignedBeaconBlockHeader


ProposerSlashing: TypeAlias = phase0.ProposerSlashing


ProposerSlashings: TypeAlias = phase0.ProposerSlashings


AttestingIndices: TypeAlias = phase0.AttestingIndices


IndexedAttestation: TypeAlias = phase0.IndexedAttestation


AttesterSlashing: TypeAlias = phase0.AttesterSlashing


AttesterSlashings: TypeAlias = phase0.AttesterSlashings
...
NodeID: TypeAlias = phase0.NodeID


SubnetID: TypeAlias = phase0.SubnetID


Ether: TypeAlias = phase0.Ether
...
ForkChoiceNode: TypeAlias = phase0.ForkChoiceNode


LatestMessage: TypeAlias = phase0.LatestMessage
