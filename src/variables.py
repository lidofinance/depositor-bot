...
# data bus
# gnosis nodes
ONCHAIN_TRANSPORT_RPC_ENDPOINTS = os.getenv('ONCHAIN_TRANSPORT_RPC_ENDPOINTS')
if ONCHAIN_TRANSPORT_RPC_ENDPOINTS:
    ONCHAIN_TRANSPORT_RPC_ENDPOINTS = ONCHAIN_TRANSPORT_RPC_ENDPOINTS.split(',')
