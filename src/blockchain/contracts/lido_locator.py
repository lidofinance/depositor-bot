...
class LidoLocatorContract(ContractInterface):
    ...
    def lido(self, block_identifier: BlockIdentifier = 'latest') -> ChecksumAddress:
        ...
        logger.info({'msg': f'Call `lido()`.', 'value': response, 'block_identifier': repr(block_identifier)})
        return response
    ...
    def deposit_security_module(self, block_identifier: BlockIdentifier = 'latest') -> ChecksumAddress:
        ...
        logger.info({'msg': f'Call `depositSecurityModule()`.', 'value': response, 'block_identifier': repr(block_identifier)})
        return response
    ...
    def staking_router(self, block_identifier: BlockIdentifier = 'latest') -> ChecksumAddress:
        ...
        logger.info({'msg': f'Call `stakingRouter()`.', 'value': response, 'block_identifier': repr(block_identifier)})
        return response
